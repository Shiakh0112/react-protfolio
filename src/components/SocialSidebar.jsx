...
const socials = [
  ...
  {
    label: 'LinkedIn', href: 'https://www.linkedin.com/in/shaikh-ashfaq-shaikh-qayyum',
    ...
    <div className="social-sidebar" style={{
      ...
      {socials.map(s => (
        <a key={s.label} href={s.href} title={s.label} target="_blank" rel="noreferrer" style={{
          ...
          onMouseEnter={e => {
            e.currentTarget.style.borderColor = 'rgba(229,197,133,0.7)'
            e.currentTarget.style.color = 'var(--accent-light-gold)'
            e.currentTarget.style.background = 'rgba(229,197,133,0.08)'
            e.currentTarget.style.transform = 'translateX(-4px)'
          }}
          onMouseLeave={e => {
            e.currentTarget.style.borderColor = 'rgba(229,197,133,0.2)'
            e.currentTarget.style.color = 'rgba(255,255,255,0.35)'
            e.currentTarget.style.background = 'rgba(10,11,14,0.7)'
      ...
      {/* bottom line */}
      <div style={{ width: '1px', height: '60px', background: 'linear-gradient(to top, transparent, rgba(229,197,133,0.4))' }} />
